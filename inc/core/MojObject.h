...
public:
	...
	MojObject(gint64 val) { m_implementation = new IntImpl(val); }
	MojObject(gint32 val) { m_implementation = new IntImpl(val); }
	 ...
	 */
	gsize size() const { return impl()->containerSize(); }
	...
	MojErr fromJson(const MojChar* str) { return fromJson(str, G_MAXSIZE); }
	MojErr fromJson(const MojChar* chars, gsize len);
	MojErr toJson(MojString& strOut) const;
	MojErr fromBytes(const guint8* data, gsize size);
	...
	MojErr putInt(const MojChar* key, gint64 val) { return put(key, MojObject(val)); }
	...
	bool get(const MojChar* key, gint64& valOut) const;
	bool get(const MojChar* key, MojDecimal& valOut) const;
	MojErr get(const MojChar* key, gint32& valOut, bool& foundOut) const;
	MojErr get(const MojChar* key, guint32& valOut, bool& foundOut) const;
	MojErr get(const MojChar* key, guint64& valOut, bool& foundOut) const;
	...
	MojErr getRequired(const MojChar* key, gint32& valOut) const;
	MojErr getRequired(const MojChar* key, guint32& valOut) const;
	MojErr getRequired(const MojChar* key, gint64& valOut) const;
	MojErr getRequired(const MojChar* key, guint64& valOut) const;
	...
	MojErr setAt(gsize idx, const MojObject& val);
	bool at(gsize idx, MojObject& objOut) const { return impl()->at(idx, objOut); }
	bool at(gsize idx, bool& valOut) const;
	bool at(gsize idx, gint64& valOut) const;
	bool at(gsize idx, MojDecimal& valOut) const;
	MojErr at(gsize idx, MojString& valOut, bool& foundOut) const;
...
private:
	...
	public:
		...
		virtual gsize hashCode() const = 0;
		virtual gsize objectSize() const = 0;
		virtual gsize containerSize() const { return 0; }
		virtual bool boolValue() const { return false; }
		virtual gint64 intValue() const { return 0; }
		...
		virtual bool at(gsize idx, MojObject& objOut) const { objOut.clear(); return false; }
	};
	...
	public:
		...
		virtual gsize hashCode() const;
		virtual MojErr visit(MojObjectVisitor& visitor) const;
		virtual gsize objectSize() const { return sizeof(NullImpl); }
	};
	...
	public:
		...
		virtual gsize hashCode() const;
		virtual gsize objectSize() const  { return sizeof(UndefinedImpl); }
	};
	...
	public:
		...
		virtual bool equals(const Impl& rhs) const;
		virtual gsize hashCode() const;
		virtual gsize containerSize() const;
		virtual bool boolValue() const;
		virtual MojErr visit(MojObjectVisitor& visitor) const;
		virtual const PropMap* map() const;
		virtual bool get(const MojChar* key, MojObject& valOut) const;
		virtual MojErr del(const MojChar* key, bool& foundOut);
		virtual gsize objectSize() const  { return sizeof(ObjectImpl); }
	...
	public:
		...
		virtual bool at(gsize idx, MojObject& objOut) const;
		virtual gsize objectSize() const  { return sizeof(ArrayImpl); }
	...
	public:
		...
		virtual gsize hashCode() const;
		virtual bool boolValue() const;
		virtual gint64 intValue() const;
		virtual MojDecimal decimalValue() const;
		virtual MojErr stringValue(MojString& valOut) const;
		virtual MojErr visit(MojObjectVisitor& visitor) const;
		virtual gsize objectSize() const  { return sizeof(StringImpl); }
	...
	public:
		...
		virtual gint64 intValue() const { return m_val; }
		virtual MojDecimal decimalValue() const { return MojDecimal(m_val, 0); }
		virtual MojErr visit(MojObjectVisitor& visitor) const;
		virtual gsize objectSize() const  { return sizeof(BoolImpl); }
	...
	public:
		...
		virtual gint64 intValue() const { return m_val.magnitude(); }
		virtual MojDecimal decimalValue() const { return m_val; }
		virtual MojErr visit(MojObjectVisitor& visitor) const;
		virtual gsize objectSize() const  { return sizeof(DecimalImpl); }
	...
	public:
		...
		virtual MojErr visit(MojObjectVisitor& visitor) const;
		virtual gsize objectSize() const  { return sizeof(IntImpl); }
...
public:
	...
	virtual MojErr propName(const MojChar* name, gsize len) = 0;
	virtual MojErr nullValue() = 0;
	virtual MojErr boolValue(bool val) = 0;
	virtual MojErr intValue(gint64 val) = 0;
	virtual MojErr decimalValue(const MojDecimal& val) = 0;
	virtual MojErr stringValue(const MojChar* val, gsize len) = 0;
	...
	MojErr intProp(const MojChar* name, gint64 val);
...
public:
	...
	virtual MojErr propName(const MojChar* name, gsize len) { return MojErrNone; }
	virtual MojErr nullValue() { return MojErrNone; }
	virtual MojErr boolValue(bool val) { return MojErrNone; }
	virtual MojErr intValue(gint64 val) { return MojErrNone; }
	virtual MojErr decimalValue(const MojDecimal& val) { return MojErrNone; }
	virtual MojErr stringValue(const MojChar* val, gsize len) { return MojErrNone; }
};
...
{
	gsize operator()(const MojObject& val)
	{
		return val.hashCode();
	}
};
