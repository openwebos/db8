...
public:
	...
	virtual MojErr put(const MojObject* begin, const MojObject* end, guint32 flags = MojDb::FlagNone);
	virtual MojErr get(const MojObject* idsBegin, const MojObject* idsEnd);
	virtual MojErr del(const MojObject* idsBegin, const MojObject* idsEnd, guint32 flags = MojDb::FlagNone);
	virtual MojErr del(const MojDbQuery& query, guint32 flags = MojDb::FlagNone);
	virtual MojErr merge(const MojObject* begin, const MojObject* end, guint32 flags = MojDb::FlagNone);
	virtual MojErr merge(const MojDbQuery& query, const MojObject& props, guint32 flags = MojDb::FlagNone);
...
private:
	...
	MojErr intRequest(const MojChar* method, const MojChar* prop, gint64 val);
	MojErr arrayRequest(const MojChar* method, const MojChar* prop,
						const MojObject* begin, const MojObject* end, guint32 flags = MojDb::FlagNone);
	MojErr queryRequest(const MojChar* method, const MojDbQuery& query, guint32 flags, bool count = false);
...
public:
	...
	virtual MojErr put(Signal::SlotRef handler, const MojObject* begin,
					   const MojObject* end, guint32 flags = MojDb::FlagNone);
	...
	virtual MojErr del(Signal::SlotRef handler, const MojObject* idsBegin,
					   const MojObject* idsEnd, guint32 flags = MojDb::FlagNone);
	...
	virtual MojErr merge(Signal::SlotRef handler, const MojDbQuery& query,
						 const MojObject& props, guint32 flags = MojDb::FlagNone);
	...
	virtual MojErr purge(Signal::SlotRef handler, guint32 window);
	virtual MojErr purgeStatus(Signal::SlotRef handler);
	virtual MojErr reserveIds(Signal::SlotRef handler, guint32 count);
...
private:
	...
	MojErr intRequest(Signal::SlotRef handler, const MojChar* method, const MojChar* prop, gint64 val);
	MojErr arrayRequest(Signal::SlotRef handler, const MojChar* method, const MojChar* prop,
						const MojObject* begin, const MojObject* end, guint32 flags = MojDb::FlagNone);
	MojErr queryRequest(Signal::SlotRef handler, const MojChar* method, const MojDbQuery& query, guint32 flags = MojDb::FlagNone,
						bool watch = false, bool count = false, guint32 numReplies = 1);
	...
	static MojErr formatIntParams(MojObjectVisitor& writer, const MojChar* prop, gint64 val);
	static MojErr formatQueryParams(MojObjectVisitor& writer, const MojDbQuery& query, guint32 flags, bool watch, bool count);
	static MojErr formatFlags(MojObjectVisitor& writer, guint32 flags);
