...
public:
	...
	virtual MojErr create(MojRefCountedPtr<MojDbStorageEngine>& engineOut) const {return MojErrNone;};
	virtual MojErr createEnv(MojRefCountedPtr<MojDbEnv>& envOut) const {return MojErrNone;};
	virtual const MojChar* name() const {return 0;};
};
...
public:
	...
	virtual MojErr open(const MojChar* path) = 0;
	virtual MojErr open(const MojChar* path, MojDbEnv * env) {return MojErrNone;};
	virtual MojErr close() = 0;
